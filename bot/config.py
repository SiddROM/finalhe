...
class Var:
    REDIS_URI = config("redis://admin:7518@Sidd@redis://default:Pn2F48emzKB7TE1nDuUAVDG8yLSmTZuK@redis-17361.c305.ap-south-1-1.ec2.cloud.redislabs.com:17361/Disha-free-db")
    REDIS_PASS = config("7518@Sidd")
